...
# Download Data
data = yf.download('OKLO', start='2024-11-27', end='2024-11-29')
data.info()
#print len of data
...
print(df)
# Define a custom data feed class inheriting from bt.feeds.PandasData
class CustomPandasData(bt.feeds.PandasData):
    ...
    params = (
        ...
        ('close', 'Close'),
        ('volume', 'Volume'),
        ('log_return', 'log_return'),  # Add log_return to the data feed
    )

# Create a Cerebro instance
cerebro = bt.Cerebro()

# Add the custom data feed to Cerebro
...
class TestStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        if len(self.data) >= 6:
            try:
                ...
                # Predict next day's, two day's, three day's, and four day's close price
    ...
    def stop(self):
        ...
        # Plot prediction signals for one-day, two-day, three-day, and four-day in different colors
        ...
        if self.predict_signals_four_day:
            ...
            # Add price labels and vertical lines for four-day prediction signals
            for date, price in self.predict_signals_four_day:
                ...
                ax2.axvline(x=date, color='orange', linestyle='--', lw=2)  # Add vertical line
